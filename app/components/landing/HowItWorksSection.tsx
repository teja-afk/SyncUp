        ...
        <div className="grid md:grid-cols-3 gap-12">
          <div className="text-center group">
            ...
            <p className="text-gray-400 text-lg leading-relaxed">
              Link your Google Calendar and we&apos;ll automatically detect your
              meetings
            </p>
          </div>
          <div className="text-center group">
            ...
            <p className="text-gray-400 text-lg leading-relaxed">
              Our AI bot automatically joins and records your meetings with full
              transcription
            </p>
          </div>
          <div className="text-center group">
            ...
            <p className="text-gray-400 text-lg leading-relaxed">
              Receive summaries, action items, and push them to your faviourite
              tools instantly
            </p>
          </div>
        </div>
